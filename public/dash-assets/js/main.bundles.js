    ...
    var i = {
      ...
      u = function () {
        KTEventHandler.trigger(n.element, "kt.dialer.change", n),
          ...
          (n.inputElement.value = s(n.value)),
        ...
        null !== e &&
          ...
          null !== t &&
            ...
            KTUtil.on(i, t, "click", function (e) {
              e.preventDefault(), (n.closeElement = this), u();
            });
      },
      l = function () {
...
(KTDrawer.getInstance = function (e) {
  ...
  (KTDrawer.handleToggle = function () {
    KTUtil.on(
      document.body,
      '[data-kt-drawer-toggle="true"][data-kt-drawer-target]',
      "click",
      function (e) {
    ...
    var i = {},
      ...
      o = function () {
        KTUtil.addEvent(n.inputElement, "change", a),
          ...
          KTUtil.addEvent(n.removeElement, "click", u);
      },
      a = function (e) {
        if (
          (e.preventDefault(),
  ...
  if (null != e) {
    var i = {
      ...
      a = function (e) {
        null !== e &&
          !0 !== m(e) &&
          ("dropdown" === T(e) ? E(e) : "accordion" === T(e) && S(e),
          KTUtil.data(e).set("type", T(e)));
      },
      l = function (e) {
        null !== e &&
          !1 !== m(e) &&
          ("dropdown" === T(e) ? w(e) : "accordion" === T(e) && A(e));
      },
      u = function (e) {
        if (!1 !== f(e)) {
          var t = p(e);
      ...
      s = function () {
        ...
        if (e && e.length > 0)
          for (var t = 0, i = e.length; t < i; t++) u(e[t]);
      },
      d = function () {
      ...
      b = function (e, t) {
        ...
        var r = Popper.createPopper(n, t, k(e));
    ...
    var i = {
      ...
      a = function () {
        var e = 0,
          t = m();
        !0 === l() && (e += t),
          !0 === n.options.checkUppercase && !0 === u() && (e += t),
          !0 === n.options.checkLowercase && !0 === s() && (e += t),
...
var KTPlace = function (e, t) {
  ...
  if (null != e) {
    var i = { mode: "append" },
      r = function () {
        (n.element = e),
          (n.options = KTUtil.deepExtend({}, i, t)),
          o(),
          KTUtil.data(n.element).set("place", n);
      },
      o = function (t) {
        var n = a("parent"),
          i = a("mode"),
    ...
    !0 === KTUtil.data(e).has("place")
      ? (n = KTUtil.data(e).get("place"))
      : r(),
      (n.update = function () {
        o();
      }),
...
(KTPlace.getInstance = function (e) {
  return null !== e && KTUtil.data(e).has("place")
    ? KTUtil.data(e).get("place")
    : null;
}),
      ...
      a = function () {
        ...
        !1 === n.element.hasAttribute("data-kt-scroll-activate")
          ? ((e = d()),
            ...
            !0 === s("save-state") && void 0 !== KTCookie && n.id
      ...
      u = function () {
        ...
        if (null !== i && (e = document.querySelectorAll(i)) && e.length > 0)
          for (var a = 0, l = e.length; a < l; a++) {
            var u = e[a];
            !1 !== KTUtil.visible(u) &&
              ((t -= parseInt(KTUtil.css(u, "height"))),
              (t -= parseInt(KTUtil.css(u, "margin-top"))),
              (t -= parseInt(KTUtil.css(u, "margin-bottom"))),
              KTUtil.css(u, "border-top") &&
                (t -= parseInt(KTUtil.css(u, "border-top"))),
              KTUtil.css(u, "border-bottom") &&
                (t -= parseInt(KTUtil.css(u, "border-bottom"))));
          }
        if (null !== r && (e = document.querySelectorAll(r)) && e.length > 0)
          for (a = 0, l = e.length; a < l; a++) {
            ...
            !1 !== KTUtil.visible(u) &&
              ((t -= parseInt(KTUtil.css(u, "margin-top"))),
              (t -= parseInt(KTUtil.css(u, "margin-bottom"))),
              (t -= parseInt(KTUtil.css(u, "padding-top"))),
              (t -= parseInt(KTUtil.css(u, "padding-bottom"))),
              KTUtil.css(u, "border-top") &&
                (t -= parseInt(KTUtil.css(u, "border-top"))),
              KTUtil.css(u, "border-bottom") &&
                (t -= parseInt(KTUtil.css(u, "border-bottom"))));
    ...
    var i = {
      ...
      o = function () {
        n.inputElement.addEventListener("focus", a),
          ...
          !0 === p("keypress") && n.inputElement.addEventListener("input", s),
          n.submitElement && n.submitElement.addEventListener("click", d),
          !0 === p("enter") && n.inputElement.addEventListener("keypress", u),
    ...
    var r = {
          ...
          !0 === o
            ? (t > r && n.lastScrollTop < t
                ...
                : (!0 === i.hasAttribute(n.attributeName) &&
                    (u(), i.removeAttribute(n.attributeName)),
      ...
      l = function (e) {
        ...
        if (
          (!0 !== e &&
            !0 === s("animation") &&
            (KTUtil.css(n.element, "animationDuration", s("animationSpeed")),
            KTUtil.animateClass(n.element, "animation " + s("animationClass"))),
          null !== o &&
  ...
  return {
    ...
    animate: function (e, t, n, i, r, o) {
      ...
      if (
        ...
        l(function a(d) {
          var c = (d || +new Date()) - s;
          c >= 0 && i(r(c, e, u, n)), c >= 0 && c >= n ? (i(t), o()) : l(a);
        });
      }
    },
        ...
        e.map(function (e) {
          return (
            e.hasAttribute("data-bs-delay-hide") &&
              (t.delay = { hide: e.getAttribute("data-bs-delay-hide") }),
            new bootstrap.Tooltip(e, t)
          );
        });
    },
    ...
    initScrollSpy: function () {
      [].slice
        ...
        .map(function (e) {
          ...
          var t = e.hasAttribute("data-bs-target-offset")
            ? parseInt(e.getAttribute("data-bs-target-offset"))
            : 0;
          KTUtil.on(
            document.body,
            e.getAttribute("data-bs-target") + " [href]",
            "click",
            function (e) {
              e.preventDefault();
  ...
  return {
    init: function () {
      (e = document.querySelector("#kt_header_search")) &&
        ...
        (u = new KTSearch(e)).on("kt.search.process", s),
        u.on("kt.search.clear", d),
