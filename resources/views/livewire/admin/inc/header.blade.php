                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-300px"
                        ...
                        <div class="menu-content fw-bold d-flex align-items-center bgi-no-repeat rounded-top"
                            style="background-image: url('img/pattern-2.jpg')">
                            <!--begin::Avatar-->
                            ...
                            <!--begin::Info-->
                            <div>
                                <span class="text-white fw-bolder fs-4">Hello, Max</span>
                                <a href="#"
                                    class="link-white fw-bold fs-6 d-block opacity-75 opacity-100-hover">max@writercrafy.co</a>
                            </div>
                            <!--end::Info-->
                        </div>
                        <!--end::Heading-->
