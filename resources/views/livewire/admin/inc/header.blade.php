                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    <div class="flex flex-nowrap mt-8">
                        ...
                        @elseif(session()->has('AuthWriter'))
                            @livewire('admin.inc.message-notification', ['user_id' => session()->get('AuthWriter'), 'user_type' => 'App\Models\Writer'])
                            @livewire('admin.inc.notification', ['user_id' => session()->get('AuthWriter'), 'user_type' => 'App\Models\Writer'])
                        @endif
