            ...
            <form class="w-full max-w-lg">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input wire:model.defer='account_no' class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="2511011" >
                        <span>
                            <button wire:click='generateAccount' type="button" class="rounded btn btn-primary">
                               Generate
                            </button>
                        </span>
                    </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <input wire:model.defer='opening_balance' class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="90210" >
                    </div>
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                    <!--begin::Title-->
                    <button wire:click='createAccount' type="button" class="rounded btn btn-primary">
                       Create
                    </button>
                    <!--end::Title-->
                </div>
