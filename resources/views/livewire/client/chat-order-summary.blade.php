                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-9 py-3" id="kt_chat_content_header">
                            ...
                            <div class="text-end flex-grow-1">
                                ...
                                <label for=""><button class="btn btn-info"><span class="rounded btn-info">Not Confirmed</span></button></label> @elseif($orderDetails->status == "In progress")
                                <label for=""><button class="btn btn-success"><span class="rounded btn-success">Confirmed</span></button></label> @endif
                        ...
                        <div class="card-body p-9">
                            <!--begin:Users-->
                            <div class="mt-9 scroll-y me-lg-n6 pe-lg-5" data-kt-scroll="true" data-kt-scroll-height="{'default' : '300px', 'lg': 'auto'}" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_aside_search" data-kt-scroll-wrappers="#kt_content, #kt_wrapper"
                                ...
                                <div class="d-flex flex-stack mb-9">
                                    ...
                                    <div class="d-flex flex-column align-items-end text-end">
                                        @if ($orderDetails->status == "Pending")
                                        <span class="badge badge-danger badge-square">{{$orderDetails->status}}</span> @elseif($orderDetails->status =="In progress")
                                        <span class="badge badge-success badge-square">{{$orderDetails->status}}</span> @endif
                                ...
                                <div class="d-flex flex-stack mb-9">
                                    ...
                                    <div class="d-flex flex-column align-items-end text-end">
                                        @if ($orderDetails->status=="Pending")
                                        <span class="badge badge-danger badge-square">${{$total_fee}}</span> @elseif($orderDetails->status=="In progress")
                                ...
                                <div class="flex-stack mb-9">
                                    <div class=" align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <a class="text-gray-600 text-hover-primary fw-bold fs-6 mb-3 ">{{$clientFile->filename}} </a>
                                            </div>
                                            <div class="col-md-4 p-3">
                                                <a  wire:click="getDownload({{ $clientFile->folder}})" href="app/public/client_files/{{$clientFile->folder}}/{{$clientFile->filename}}" target="_blank" type="button" class="btn-floating btn-small" download="{{$clientFile->filename}}">  <span class="svg-icon svg-icon-3">
                                    ...
                                    @guest
                                    <button class="btn btn-info"> Add Files</button> @endguest
                                </div>
                                <!--end:User-->
                ...
                <div class="flex-lg-row-fluid ms-lg-12" id="kt_chat_content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-9">
                            ...
                            <!--begin::Scroll-->
                            <div class="scroll-y me-lg-n6 pe-lg-5" data-kt-scroll="true" data-kt-scroll-height="{'default' : '400px', 'lg' : 'auto'}" data-kt-scroll-dependencies="#kt_header, #kt_toolbar, #kt_footer, #kt_chat_content_header, #kt_chat_content_footer" data-kt-scroll-wrappers="#kt_content, #kt_wrapper"
                        ...
                        <div class="card-footer align-items-center px-7 py-4" id="kt_chat_content_footer">
                            ...
                            <form wire:submit.prevent='sendMessage'>
                                ...
                                <div class="position-relative">
                                    <textarea wire:model.defer='messageText' class="form-control border-0 p-2 resize-none overflow-hidden" rows="1" placeholder="Reply..."></textarea>
