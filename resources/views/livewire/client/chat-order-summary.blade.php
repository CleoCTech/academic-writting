                                ...
                                <div wire:poll class="messages" wire:model.defer='messages' id="messages">
                                    ...
                                    <div class="justify-around">
                                        <div class="flex">
                                            ...
                                            <span class="relative inline-flex rounded-md shadow-sm ml-2 cursor-pointer hover:bg-purple-700">
                                            ...
                                            <div class="row bg-indigo-600 bg-opacity-25">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="text-blue-400 uppercase "
                                                                style="margin-top: -1rem;">Accepting Order From Writer
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="text-blue-400 uppercase "
                                                                style="margin-top: -1rem;">Rejecting Order
                                    ...
                                    <div class=" align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mt-4">
                                                ...
                                                <div wire:ignore class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <input type="file" wire:model.defer='companyFile'
                                                            name="paperFile" id="test" multiple>
                                                    </div>
                                                    <script type="text/javascript">
                                                        const inputElement = document.querySelector('input[id="test"]');
                                                    const pond = FilePond.create( inputElement );
                                                ...
                                                <div class="row bg-indigo-600 bg-opacity-25">
                                                    <div class="col-sm-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <h4 class="text-blue-400 uppercase "
                                                                    style="margin-top: -1rem;">Accepting Order From
                                                                    Writer
                                                                    <span class="svg-icon svg-icon-3 text-yellow-500">
                                                                        <i
                                                                            class="bi bi-exclamation-triangle text-yellow-500"></i>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <p
                                                                    class=" mb-4 font-sans md:font-serif text-gray-400 hover:text-blue-700">
                                                                    Before rejecting the order, preview the work and
                                                                    assertain that instructions you gave were not
                                                                    followed.</p>
